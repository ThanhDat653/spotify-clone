...
export default function TopBar() {
   return (
      <header className="flex items-center justify-between px-4 py-2 bg-black border-b border-neutral-800">
         {/* Left Section */}
         <div className="flex items-center gap-2">
            ...
            {/* Search Box */}
            <div className="flex items-center bg-neutral-800 rounded-full px-3 py-1 ml-2 md:ml-4 w-[200px] md:w-[300px]">
